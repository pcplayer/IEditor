...
type
  TAfterCatchScreenEvent = procedure(AFileName: string) of object;
  ...
  private
    ...
    FAfterCatchScreen: TAfterCatchScreenEvent;
  ...
  public
    ...
    property NLAfterCatchScreen: TAfterCatchScreenEvent read FAfterCatchScreen write FAfterCatchScreen;
